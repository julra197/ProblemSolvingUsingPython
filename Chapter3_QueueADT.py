...
print("queue1 population lasts: ", t1.timeit(number=1000))
t2 = timeit.Timer("populate(range(0, 1000), q2)", "from __main__ import q2, populate")
print("queue2 population lasts: ", t2.timeit(number=1000))
t3 = timeit.Timer("retrieve(q1)", "from __main__ import q1, retrieve")
print("queue1 retrieving lasts: ", t3.timeit(number=1000))
t4 = timeit.Timer("retrieve(q2)", "from __main__ import q2, retrieve")
print("queue2 retrieving lasts: ", t4.timeit(number=1000))